...
public class BookmarkRestControllerTest {
    ...
    public void userNotFound() throws Exception {
        mockMvc.perform(post("/users/george/bookmarks/")
    ...
    public void createBookmark() throws Exception {
        // json string to post!
        String bookmarkJson = json(new Bookmark(this.account, "http://spring.io", " a bookmark to the best resource on Spring"));
        this.mockMvc.perform(post("/users/" + userName + "/bookmarks")
    ...
    public void readSingleBookmark() throws Exception {
        mockMvc.perform(get("/users/" + userName + "/bookmarks/"
